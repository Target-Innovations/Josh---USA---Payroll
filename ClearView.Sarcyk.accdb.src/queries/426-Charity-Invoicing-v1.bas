Operation =1
Option =0
Where ="(((TicketDistribution.CharityId)=[TempVars]![CharityId]) AND ((TicketDistributio"
    "n.DistributionDate)=GetTempVar(\"StartDate\"))) OR (((TicketDistribution.Charity"
    "InvoiceNumber)=[TempVars]![CharityInvoiceNumber]))"
Begin InputTables
