...
Begin Report
    ...
    ItemSuffix =37
    Filter ="1=1 And LocationId  = 60 And  DateRange  Between #2025-01-01# And #2025-02-28#"
    RecSrcDt = Begin
        0x8c484f13d750e640
    End
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    FontSize =16
                    Name ="Text13"
                    ControlSource ="=\"Collection Range: \" & [TempVars]![StartDate] & \" Thru \" & [TempVars]![EndD"
                        "ate]"
                    Format ="Long Date"
...
'    TempVars!StartDate = Me.StartDate
'    TempVars!EndDate = Me.EndDate
'
