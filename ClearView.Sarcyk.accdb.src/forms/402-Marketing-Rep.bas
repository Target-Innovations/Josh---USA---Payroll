                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:400-Home-SMAC</Argument></Action><Action Name=\"CloseWindow\"><Argument Nam"
                                "e=\"ObjectType\">Form</Argument><Argument Name=\"ObjectName\">402-Marketing-Rep<"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =4
                    Name ="CharityAdded%"
                    ControlSource ="CharityAdded%"
                    Format ="$#,##0.00;-$#,##0.00"
                    EventProcPrefix ="CharityAdded_"
                    GroupTable =31
                    LeftPadding =0
                    TopPadding =0
                    RightPadding =0
