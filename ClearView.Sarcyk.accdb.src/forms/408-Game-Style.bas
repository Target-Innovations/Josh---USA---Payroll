                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:400-Home-SMAC</Argument></Action><Action Name=\"CloseWindow\"><Argument Nam"
                                "e=\"ObjectType\">Form</Argument><Argument Name=\"ObjectName\">408-Game-Style</Ar"
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:[MacroError].[Description]</Argument></Action><Action Name=\"StopMacro\"/><"
                                ...
                                "\">422-Game-Style-Detai"
                        End
                        Begin
                            Comment ="_AXL:ls</Argument><Argument Name=\"WhereCondition\">=\"[ID]=\" &amp; Nz([ID],0)<"
                                "/Argument><Argument Name=\"WindowMode\">Dialog</Argument></Action><ConditionalBl"
                                "ock><If><Condition>Not IsNull([ID])</Condition><Statements><Action Name=\"SetTem"
                                "pVar\"><Argument Name"
                        End
                        Begin
                            Comment ="_AXL:=\"Name\">CurrentID</Argument><Argument Name=\"Expression\">[ID]</Argument>"
                                "</Action></Statements></If></ConditionalBlock><ConditionalBlock><If><Condition>I"
                                "sNull([ID])</Condition><Statements><Action Name=\"SetTempVar\"><Argument Name=\""
                                "Name\">CurrentID</Arg"
                        End
                        Begin
                            Comment ="_AXL:ument><Argument Name=\"Expression\">Nz(DMax(\"[ID]\",[Form].[RecordSource])"
                                ",0)</Argument></Action></Statements></If></ConditionalBlock><Action Name=\"Remov"
